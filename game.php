...
<div class="game-view-container" style="display:flex; flex-direction:column; gap:20px; height:100%;">
    <div class="game-window"
        ...
        <div id="game-container" style="width:100%; height:100%; position:relative; overflow:hidden;">
            ...
            <div class="game-hud" style="position:absolute; inset:0; pointer-events:none; padding:24px;">
                <div style="display:flex; justify-content:space-between; align-items:flex-start;">
                    <div id="game-hud-score"
                        style="font-family:var(--font-game); font-size:48px; font-weight:900; color:white; text-shadow:3px 3px 0 #000, 0 0 20px rgba(0,0,0,0.5);">
                        0</div>
                    <div id="game-hud-multiplier"
                        style="background:var(--gold); color:black; font-weight:900; font-size:14px; padding:6px 14px; border-radius:4px; display:none; box-shadow:3px 3px 0 #000;">
                        1.0×</div>
                </div>

                <div id="game-hud-powerup"
                    style="position:absolute; bottom:30px; left:50%; transform:translateX(-50%); width:200px; background:rgba(0,0,0,0.7); padding:10px; border-radius:8px; display:none; flex-direction:column; gap:5px; border:2px solid var(--purple);">
                    <div
                        style="display:flex; justify-content:space-between; font-size:10px; font-weight:bold; color:var(--purple-bright);">
            ...
            <!-- Game Over Screen -->
            <div id="game-overlay"
                style="display:none; position:absolute; inset:0; background:rgba(0,0,0,0.9); backdrop-filter:blur(8px); flex-direction:column; align-items:center; justify-content:center; text-align:center; padding:40px; border:4px solid var(--purple); margin:20px; border-radius:12px;">
                <div
                    style="font-size:12px; font-weight:bold; color:var(--text-muted); text-transform:uppercase; letter-spacing:3px;">
                    Simulation Terminated</div>
                <div id="go-score" style="font-size:80px; font-weight:900; color:white; line-height:1; margin:10px 0;">0
                </div>
                <div id="go-best" style="font-size:14px; color:var(--green); font-weight:bold; margin-bottom:20px;">
                </div>
                ...
                <div class="go-stats"
                    ...
                    <div class="go-stat-box"
                        style="background:var(--bg-input); padding:15px; border-radius:8px; border:1px solid var(--border-dim);">
                ...
                <div style="display:flex; gap:15px;">
                    ...
                    <a href="<?= BASE_URL ?>/leaderboard.php" class="btn-pixel"
                        style="background:var(--bg-card); min-width:160px;">RANKINGS</a>
                </div>
    ...
    <!-- Leaderboard Preview -->
    <div id="leaderboard-section" class="widget"
        style="background:var(--bg-panel); border-radius:var(--radius); padding:20px;">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
            <h3 style="margin:0; font-size:18px;"><i class="fas fa-trophy"
                    style="color:var(--gold); margin-right:10px;"></i>Top Pilots</h3>
            <div class="tabs"
