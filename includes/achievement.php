...
function check_and_grant_achievements($user_id, $trigger_type, $trigger_data = [])
{
    ...
    switch ($trigger_type) {
        case 'game_submit':
            ...
            if ($score >= 500)
                $achievements_to_check[] = 'score_500';
            if ($score >= 2000)
                $achievements_to_check[] = 'score_2000';
            if ($score >= 5000)
                $achievements_to_check[] = 'score_5000';
            if ($score >= 10000)
                $achievements_to_check[] = 'score_10000';

            if ($speed_tier >= 3)
                $achievements_to_check[] = 'speed_tier_3';
            if ($speed_tier >= 5)
                $achievements_to_check[] = 'speed_tier_5';
            if ($speed_tier >= 7)
                $achievements_to_check[] = 'speed_tier_7';
        ...
        case 'pixel_buy':
            ...
            if ($total_pixels == 1)
                $achievements_to_check[] = 'first_pixel';
            if ($total_pixels >= 50)
                $achievements_to_check[] = 'pixels_50';
            if ($total_pixels >= 250)
                $achievements_to_check[] = 'pixels_250';
            if ($total_pixels >= 1000)
                $achievements_to_check[] = 'pixels_1000';
        ...
        case 'combo':
            ...
            if ($combo >= 15)
                $achievements_to_check[] = 'combo_15';
            if ($combo >= 35)
                $achievements_to_check[] = 'combo_35';
        ...
        case 'login':
            ...
            if ($streak >= 3)
                $achievements_to_check[] = 'streak_3';
            if ($streak >= 7)
                $achievements_to_check[] = 'streak_7';
            if ($streak >= 30)
                $achievements_to_check[] = 'streak_30';
            if ($total_earned >= 100)
                $achievements_to_check[] = 'total_earned_100';
